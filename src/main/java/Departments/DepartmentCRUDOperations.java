...
public class DepartmentCRUDOperations {
    ...
    public void insertDepartment(String departmentName, String departmentDescription, User user, int createdBy, Timestamp createdOn) {
    ...
    public void updateDepartment(long departmentId, String newDepartmentName, String newDepartmentDescription, User newDirector) {
